...
/**
 * JSON body: manager → worker (POST /internal/api/worker/hash/crack/task).
 */
public class WorkerTaskRequest {
    ...
    public WorkerTaskRequest(String requestId, String hash, String alphabet,
                             int maxLength, int partNumber, int partCount) {
